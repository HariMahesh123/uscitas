...
class Classifier:
    def __init__(self, bucketPrefix, testBucketNumber, dataFormat):
        ...
        #
        #  done counting. now compute probabilities
        #
    ...
    def testFile(self, bucketPrefix, bucketNumber):
        """Evaluate the classifier with data from the file
        bucketPrefix-bucketNumber"""
        ...
        for line in lines:
            ...
            classifiedAs = self.classify(vector, numV)
            print(vector, numV, classifiedAs)
            totals[classifiedAs] += 1
        return totals
...
# This is how we run the classifier. First construct it and then test a bucket of data. A bucket is nothing but a set of rows.
#c = Classifier("/home/sakella/examples/structuredbayes/traffic/i", 0, "attr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tattr\tclass")
#t = c.testFile("/home/sakella/examples/structuredbayes/traffic/i", 1)
#print("Result:")
#print(t)
# This is how we can classify a single row of data and print the results.
#print(c.classify(['unkip', 'yes', 'unkdom', 'no', 'yes', 'GET', 'yes', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'none'], []))

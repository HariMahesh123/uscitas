...
def run(inputfolder):
    ...
    macaddr = s.mac
    print "Mac address of the device sniffing" + macaddr
    s.ReadPackets()
...
def main(argv):
    ...
    for opt, arg in opts:
        if opt == '-h':
            ...
            print 'runner.py -m -i <path to folder containing pcaps> -o <path and outputfile filename for extracted data>'
            print "To generate training data using good pcaps:"
            print 'runner.py -b -i <path to folder containing pcaps> -o <path and outputfile filename for extracted data>'
